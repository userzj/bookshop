		...
		<div class="col-md-4 products-left">
			...
			<div class="css-treeview">
				...
				<ul class="tree-list-pad">
					<li><input type="checkbox" checked="checked" id="item-0" /><label for="item-0"><span></span>图书分类</label>
						<ul>
		...
		<div class="col-md-8 products-right">
			...
			<div class="men-wear-bottom">
				<div class="col-sm-4 men-wear-left">
					<img class="img-responsive" src="images/Fh-brbqTCQrVJNkzSug7T9u-xsZe.jpg" alt=" " />
				</div>
				<div class="col-sm-8 men-wear-right">
					<h4>名言警句</h4>
					<p>Books are the quietest and most constant of friends; they are the most accessible and wisest of counselors; and the most patient of teachers. -C.W.Eliot</p>
					<p>书籍是人类最宁静很最永恒的朋友，也是最易接近和最具智慧的顾问，还是最有耐心的良师益友。 -C.W.艾略特</p>
				</div>
				<div class="clearfix"></div>
			</div>
			<%
    			...
    			for(Book book : list){
					...
					<div class="men-pro-item simpleCart_shelfItem">
						<div class="men-thumb-item">
							<img src="images/<%=book.getPicture() %>" alt="" class="pro-image-front">
							<img src="images/<%=book.getPicture() %>" alt="" class="pro-image-back">
										<div class="men-cart-pro">
											<div class="inner-men-cart-pro">
												<a href="aBookDetail.action?id=<%=book.getId() %>" class="link-product-add-cart">详情</a>
											</div>
										</div>
						...
						<h4><a href="aBookDetail.action?id=<%=book.getId() %>"></a></h4>
						<div class="info-product-price">
							<span class="item_price">￥<%=book.getPrice() %></span>
							<del>￥<%=book.getPrice() %></del>
						</div>
						<a href='addToCart.action?id=<%=book.getId() %>' class="item_add single-item hvr-outline-out button2">加入购物车</a>									
					</div>
