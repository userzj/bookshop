...
<script src="js/jquery.easing.min.js"></script>
	<script type="text/javascript">		
		function testPost(){
			...
			$.post("userRegisiter1.action",{username:$("#username").val()},function(tt){
				$("#ulab").html(tt);
			});
		}
	</script>
...
<br />
<form action="userRegisiter2.action" method="post" name="form2" id="form2">
      ...
      <td>
        <table width="100%" border="0" cellspacing="0" cellpadding="4">
          <tr class="HeaderColor">
            ...
            <td width="20%" style="vertical-align: top">              <h3>用户注册</h3>            </td>
          ...
          <tr style="vertical-align: top">
            ...
            <td width="20%" class="TitleColor">
              ...
              <label id="ulab"></label>
              <br />
              <input id="username" name="username" type="text" size="25" onblur="testPost()" />
              <p>&nbsp;</p>
              <label for="password"><strong>密码</strong></label><label id = "plab"></label>&nbsp;<br />
              <input id="password" name="password" type="password" size="25" onblur = "testPassword()" /><br />
               <p>&nbsp;</p>
               <label for="password"><strong>重复密码</strong></label><label id = "rlab"></label>&nbsp;<br />
              <input id="repassword" name="repassword" type="password" size="25" onblur = "testRepeatPassword()" /><br />
              <p>
